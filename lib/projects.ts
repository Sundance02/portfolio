...
export const projects: Project[] = [
  {
    ...
    techStack: ['Next.js', 'MongoDB', 'Tailwind CSS', 'OpenWeather API', 'Leaflet.js'],
  ...
  },
  {
    id: 'offlearn',
    title: 'OFFlearn',
    subtitle: 'Learning Management Website.',
  ...
  },
  {
    ...
    subtitle: 'AI-Powered Waste Classification Mobile Application.',
    ...
    techStack: ['React Native', 'Express.js', 'Node.js', 'PostgreSQL'],
    ...
    category: 'Website • Mobile Application • Deep learning',
    year: '2025'
  }
];
